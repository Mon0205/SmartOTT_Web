          ...
          {friends.length === 0 ? (
            ...
            friends.map((friend) => {
              return (
                <div
                  key={friend._id}
                  className="d-flex align-items-center justify-content-between gap-2 p-3 border rounded mb-2"
                  role="button"
                  tabIndex={0}
                  onClick={() => onOpenFriendChat?.(friend)}
                  onKeyDown={(e) => {
                    if (e.key === "Enter") onOpenFriendChat?.(friend);
                  }}
                ...
                >
                  ...
                  <div className="d-flex gap-2 flex-shrink-0">
                    ...
                    >
                      {processingFriendId === friend._id ? "Dang huy..." : "Huy ket ban"}
                    </button>
                  </div>
                </div>
              );
